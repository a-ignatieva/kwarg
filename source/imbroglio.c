...
static void _print_usage(FILE *f, char *name)
{
    ...
    print_option(f, "-s", "Whether to skip collapsing together adjacent identical columns (default s=1 means yes, s=0 means no)", 80, -1);
...
int main(int argc, char **argv)
{
    ...
    #define SIMPLIFY_OPTIONS "b::ksofanQhH?"
